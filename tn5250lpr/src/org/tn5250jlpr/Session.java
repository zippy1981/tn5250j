...
public class Session implements SessionInterface,TN5250jConstants {
...
// 
      ...
      if (sesProps.containsKey(SESSION_OUTPUT)){
         vt.setOutput((String)sesProps.getProperty(SESSION_OUTPUT));
	 System.out.println("vt.outputType = " + vt.getOutput());
      }
