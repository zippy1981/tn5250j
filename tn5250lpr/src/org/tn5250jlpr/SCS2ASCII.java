...
public final class SCS2ASCII implements LPRInterface {
...
//      System.out.println(line);
   ...
   private void scs_D2() throws Exception {
      ...
      switch (function) {
         ...
         case SCS_D2_SHM:
            leftMargin =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;
            rightMargin =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;

            System.out.println(" Set horizontal margins: left " + leftMargin +
                                 " right: " + rightMargin);
            break;
         case SCS_D2_SVM:
            topMargin =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;
            if (byte0 == 06)
               bottomMargin =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;

            System.out.println(" Set vertical margins: top " + topMargin +
                                 " bottom: " + bottomMargin);
            break;
         ...
         case SCS_D2_PPM:
            ...
            break;
         case SCS_D2_SPPS:
            pgWidth =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;
            pgHeight =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;
            ...
            break;
         case SCS_D2_SSLD:
            int distance =  (bk.getNextByte() & 0xff) << 8 | bk.getNextByte() & 0xff;

            // distance divided by 144ths of an inch
